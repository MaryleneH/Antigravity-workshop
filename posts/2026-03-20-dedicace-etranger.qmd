...
<div class="belgium-futurist-article">
  ...
  <div class="belgium-event-info">
    <div class="event-glow">
      ...
      <p>✨ Stand 134, près du bar — parce que mes livres font plus d'effet que les cocktails ! Passez me dire bonjour, ça me fera chaud au cœur… et qui sait, vous repartirez peut-être avec une histoire qui vous touchera !</p>
      <p>🌐 <a href="https://salonlovestory.be" target="_blank" rel="noopener noreferrer" class="event-link">salonlovestory.be</a></p>
    </div>
  </div>
  ...
  <div class="album-carousel" id="belgiumAlbum">
    ...
    <p class="futurist-gallery-caption">Mons, Belgique · 20 mars 2026</p>
  </div>
