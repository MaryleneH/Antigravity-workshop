...
<div class="ar-page">
  ...
  <div class="ar-header">
    <span class="ar-badge">✦ Pose avec AT The Beginning</span>
    <h1>Votre moment AT</h1>
    <p>Activez la caméra, positionnez le livre à côté de vous et capturez votre photo souvenir.</p>
  </div>
  ...
  <div class="ar-stage" id="ar-stage">
    ...
    <div id="start-overlay">
      ...
      <p>Cliquez ci-dessous pour activer votre caméra — le livre apparaîtra à côté de vous !</p>
    </div>
  ...
  <div class="ar-tips">
    <div class="ar-tip">
      ...
      Glissez le livre pour le placer à côté de votre visage.
    </div>
    <div class="ar-tip">
      <strong>↔ Taille</strong>
      Faites glisser le coin ↘ pour redimensionner le livre.
    </div>
    <div class="ar-tip">
      <strong>📸 Capture</strong>
      La photo sera téléchargée automatiquement.
    </div>
  </div>
