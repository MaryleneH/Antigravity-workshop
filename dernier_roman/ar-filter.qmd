...
#preview-hint strong { color: #C9A87C; }
...
<div class="ar-page">
  ...
  <div class="ar-tips">
    ...
    <div class="ar-tip">
      ...
      Votre photo s'affiche — appui long pour l'enregistrer sur mobile.
    </div>
  </div>
...
<div id="photo-preview">
  <img id="preview-img" src="" alt="Votre photo AT">
  <div id="preview-hint">
    <strong>📱 Mobile :</strong> appui long sur la photo → "Enregistrer l'image"<br>
    <strong>💻 Desktop :</strong> clic droit → "Enregistrer l'image sous"
  </div>
  <button class="ar-btn ar-btn-capture" onclick="document.getElementById('photo-preview').classList.remove('open')" style="margin-top:0.5rem;">✕ Fermer</button>
</div>
...
(function () {
  ...
  window.capturePhoto = function () {
    ...
    // Capture at the video's NATIVE resolution for full quality
    ...
    // Draw mirrored video at full native resolution
    ctx.save();
    ...
    // Scale book position from CSS pixels → native pixels
    var scaleX = nativeW / stageW;
    var scaleY = nativeH / stageH;
    var br = book.getBoundingClientRect();
    var sr = stage.getBoundingClientRect();
    var bx = (br.left - sr.left) * scaleX;
    var by = (br.top  - sr.top)  * scaleY;
    var bw = br.width  * scaleX;
    var bh = br.height * scaleY;

    // Draw book directly — same-origin img, no CORS taint
    try { ctx.drawImage(book, bx, by, bw, bh); } catch(e) { console.warn(e); }
    ...
    // Show in-page preview (works on ALL browsers/mobile)
    var preview = document.getElementById('photo-preview');
    var previewImg = document.getElementById('preview-img');
    previewImg.src = dataUrl;
    preview.classList.add('open');

    // Also attempt auto-download (works on desktop Chrome/Firefox)
    try {
      var a = document.createElement('a');
      a.href = dataUrl;
      a.download = 'AT-The-Beginning-pose.jpg';
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
    } catch(e) { /* silent — user can save from preview */ }

    setStatus('✦ Photo prête — appui long pour enregistrer sur mobile');
  };
